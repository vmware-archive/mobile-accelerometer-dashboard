...
class AccelerometerRestControllerSpec extends Specification {
	...
	void "Post a single movement as JSON"() {
		...
		request.json = '{'  '''"device":"iphone","time":303200.44781484455,"activity":"Running","lat":37.709358,
					"lon":-121.868416,"alt":126.682396,"diffX":3.225708,"diffY":0.85907,
					"diffZ":6.219482,"xcoord":0.301178,"ycoord":-0.48645,"zcoord":-0.846161'''+'}'
        controller.save()
